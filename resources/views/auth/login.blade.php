                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">ClassRoom</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Bienvenido a classroom! 👋</h4>
                        <p class="mb-4">Por favor inicia sesión para continuar</p>

                        <form id="formAuthentication" action="{{ route('login.signIn') }}" class="mb-3" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="email" class="form-label">Email</label>
                                <input type="text" value="{{ old('email') }}" name="email" class="form-control"
                                    id="email" placeholder="Ingresa tu email" autofocus required/>
                            </div>
